...
using Nop.Plugin.LaSoTuVi.Infrastructure.Cache;
using Nop.Plugin.LaSoTuVi.Models;
using Nop.Services.Configuration;
using Nop.Services.Media;
using Nop.Web.Framework.Components;

namespace Nop.Plugin.LaSoTuVi.Components
{
    [ViewComponent(Name = "LaSoTuVi")]
    public class LaSoTuViViewComponent : NopViewComponent
    {
        ...
        public LaSoTuViViewComponent(IStoreContext storeContext, 
        ...
        {
            var nivoSliderSettings = _settingService.LoadSetting<LaSoTuViSettings>(_storeContext.CurrentStore.Id);
            ...
            return View("~/Plugins/LaSoTuVi/Views/PublicInfo.cshtml", model);
        }
